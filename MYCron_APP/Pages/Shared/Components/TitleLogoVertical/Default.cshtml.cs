...
{
    public class TitleLogoVerticalViewComponent : ViewComponent
    {
        [BindProperty]
        ...
        public async Task<IViewComponentResult> InvokeAsync(int LogoSize = 150, string TitleClasses = "title-text", string Suffix = "",string SuffixClasses = "d-none")
        {
